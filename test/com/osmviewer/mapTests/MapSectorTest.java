...
import com.osmviewer.map.MapSectorLoadingHandler;
...
public class MapSectorTest
{
	...
	public void loadingWithNullDataSourceTest() throws FetchingErrorException
	{
		try
		{
			...
			sector.loadObjects(null, new TestRenderableMapObjectsDrawSettingsFinder(), new TestMapSectorLoadingHandler());
			fail();
		}
		catch (IllegalArgumentException ex)
		{
