...
/**
 ...
 \param area - area using to deterimine which map objects need to fetch. Must be not null
 \param fetchResultsHandler - handler of fetching results. Must be not null
 */
